...
#TTD's pval = 0.851, therefore TTD not included in this model
#TNFb, il5, and il9 included
...
saveRDS(tune_results, "Data/tune_results_baselinemodel_petct3_transf.rds")


#Step8: Tune results object----------
tune_results <- readRDS("Data/tune_results_baselinemodel_petct3_transf.rds")
